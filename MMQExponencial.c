...
scanf("%d", &n);
double x[n],y[n], A[2][2], b[2][1], fator_m, beta_1, beta_2, h[n], erro, c1,c2;
...
printf("\nCom isso chegamos em g(x)=%lf(%lf^x))",c1,c2);
